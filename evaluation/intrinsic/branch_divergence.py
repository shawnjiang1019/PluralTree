...
Usage (standalone ranking):
    python -m evaluation.intrinsic.branch_divergence --embeddings runs/h_all.pt \
...
from evaluation.intrinsic.structure_metrics import _parents_from_children, _depths
...
def _main():
    ...
    ap.add_argument("--dataset", choices=["wn18rr", "culturalbench", "globalopinionqa", "grailqa", "opinionqa"], default="wn18rr")
