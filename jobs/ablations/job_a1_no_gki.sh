#!/bin/bash
#SBATCH --job-name=a1_no_gki
#SBATCH --gres=gpu:1
#SBATCH --mem=16G
#SBATCH --time=08:00:00
#SBATCH --account=def-enaskt
#SBATCH --output=logs/a1_no_gki_%j.out
#SBATCH --error=logs/a1_no_gki_%j.err
...
python scripts/train/train.py --device cuda --n_epochs 300 --d_hidden 128 --warmup1 400 --warmup2 1600 --embed_model all-mpnet-base-v2 --no_gki
