...
#
# Examples:
#   sbatch jobs/eval/job_map_reader.sh                                  # full 7B run
#   SMOKE=1 sbatch jobs/eval/job_map_reader.sh                          # dry run
#   EMB=embeddings_both_ind.pt sbatch jobs/eval/job_map_reader.sh
...
python scripts/sft/generate_map_reader_sft.py \
...
# --- 2. QLoRA SFT (GPU) --------------------------------------------------
echo "### Step 2: train"
python scripts/train/train_map_reader.py \
